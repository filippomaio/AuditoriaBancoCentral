											...
											for(int i = 0; i < listaIdMitigacao.size(); i++) {
 											...
 											<tr>
 												<td><%=idMitigacao%></td>
                  								...
                  								<td><button type="button" class="btn btn-secondary"><a href="Mitigacao.do?acao=editar&idMitigacao=<%=idMitigacao%>">Editar</a></button></td> 
                  								<td><button type="button" class="btn btn-secondary"><a href="Mitigacao.do?acao=remover&idMitigacao=<%=idMitigacao%>">Remover</a></button></td> 
                  							</tr>															
 											<% } //fecha for
											%>
											</tbody>
