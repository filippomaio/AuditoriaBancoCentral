...
<body class="is-preload">
	...
	<h1 style="text-align: center; margin: 0px;">Quadro de Hiato de
		Controle</h1>
	<!-- Wrapper -->
	<div id="wrapper" class="wrapper">
		<!-- Main -->
		<h2 class="rankingText">Ranking do Risco</h2>
	...
	<h2 style="text-align: center; margin: 0px; padding: 0px;">Eficácia
		do Controle</h2>
