											...
											for(int i = 0; i < listaIdObjeto.size(); i++) {
 											...
 											<tr>
 												<td><%=idObjeto%></td>
                  								...
                  								<td><button type="button" class="btn btn-secondary"><a href="Objeto.do?acao=editar&idObjeto=<%=idObjeto%>">Editar</a></button></td> 
                  								<td><button type="button" class="btn btn-secondary"><a href="Objeto.do?acao=remover&idObjeto=<%=idObjeto%>">Remover</a></button></td> 
                  							</tr>															
 											<% } //fecha for
											%>
											</tbody>
